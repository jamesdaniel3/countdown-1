...
addNewEntry("Harry Potter", "JK Rowling");
console.log(bookList);
// (2) Write an arrow function that removes a specific book from the bookList

const removeEntry = (title, author) => {
  bookList.pop({ title: title, author: author });
};
removeEntry("Harry Potter", "JK Rowling");
console.log(bookList);
...
listBooksOrAuthors("books");
listBooksOrAuthors("authors");
...
const getDayMessage = (day) => {
  switch (day.toLowerCase()) {
    ...
    case "friday":
      ...
      break;
    default:
      console.log("No special message for this day.");
  }
};
